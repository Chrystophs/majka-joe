...
<?php if (!empty($fb)) : ?>
	<a href="<?php echo $fb; ?>" target="_blank">
		<svg class="icon2 icon-facebook-<?php echo $icon_style; ?>" viewBox="0 0 32 32">
...
<?php if (!empty($twitter)) : ?>
	<a href="<?php echo $twitter; ?>" target="_blank">
		<svg class="icon2 icon-twitter-<?php echo $icon_style; ?>" viewBox="0 0 32 32">
...
<?php if (!empty($google)) : ?>
	<a href="<?php echo $google; ?>" target="_blank">
		<svg class="icon2 icon-googleplus-<?php echo $icon_style; ?>" viewBox="0 0 32 32">
...
<?php if (!empty($linkedin)) : ?>
	<a href="<?php echo $linkedin; ?>" target="_blank">
		<svg class="icon2 icon-linkedin-<?php echo $icon_style; ?>" viewBox="0 0 32 32">
